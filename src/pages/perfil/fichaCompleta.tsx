                ...
                <IonCardContent className="card-content-slide">
                    <IonItem>
                        <div className="w-100 pb-1">
                            <div className="fs-12">
                                <FontAwesomeIcon icon={faCircle} className="text-info-dark mr-2 fs-6" /> 
                                Fecha de nacimiento
                            </div>
                            <div className="fs-13 font-w500 pl-3">03 de Diciembre de 1987</div>
                        </div>
                    </IonItem>
                    <IonItem>
                    ...
                    <IonItem>
                        <div className="w-100 pt-3 pb-1">
                            ...
                            <div className="fs-13 font-w500 pl-3">
                                ...
                                <span className="text-light float-right">Ver carnet de SENADIS</span>
                            </div>
                        </div>
                    </IonItem>
                    <IonItem>
